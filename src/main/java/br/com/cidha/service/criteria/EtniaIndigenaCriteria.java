...
/**
 * Criteria class for the {@link br.com.cidha.domain.EtniaIndigena} entity. This class is used
 * in {@link br.com.cidha.web.rest.EtniaIndigenaResource} to receive all the possible filtering options from
...
public class EtniaIndigenaCriteria implements Serializable, Criteria {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(nome, that.nome) && Objects.equals(terraIndigenaId, that.terraIndigenaId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, nome, terraIndigenaId);
    }
