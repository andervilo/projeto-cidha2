...
/**
 * Spring Data  repository for the ParteInteresssada entity.
 */
@Repository
public interface ParteInteresssadaRepository extends JpaRepository<ParteInteresssada, Long>, JpaSpecificationExecutor<ParteInteresssada> {
    ...
    @Query(value = "select distinct parteInteresssada from ParteInteresssada parteInteresssada left join fetch parteInteresssada.representanteLegals",
    ...
    @Query("select distinct parteInteresssada from ParteInteresssada parteInteresssada left join fetch parteInteresssada.representanteLegals")
    List<ParteInteresssada> findAllWithEagerRelationships();

    @Query("select parteInteresssada from ParteInteresssada parteInteresssada left join fetch parteInteresssada.representanteLegals where parteInteresssada.id =:id")
