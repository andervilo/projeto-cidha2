...
/**
 * Spring Data  repository for the ProcessoConflito entity.
 */
@Repository
public interface ProcessoConflitoRepository extends JpaRepository<ProcessoConflito, Long>, JpaSpecificationExecutor<ProcessoConflito> {
    ...
    @Query(value = "select distinct processoConflito from ProcessoConflito processoConflito left join fetch processoConflito.direitos",
    ...
    @Query("select processoConflito from ProcessoConflito processoConflito left join fetch processoConflito.direitos where processoConflito.id =:id")
