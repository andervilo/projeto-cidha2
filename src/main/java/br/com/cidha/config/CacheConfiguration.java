...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, br.com.cidha.domain.Processo.class.getName() + ".emargoRespRes");
            createCache(cm, br.com.cidha.domain.Processo.class.getName() + ".emargodeclaracaoAgravos");
            createCache(cm, br.com.cidha.domain.Processo.class.getName() + ".emargoDeclaracaos");
