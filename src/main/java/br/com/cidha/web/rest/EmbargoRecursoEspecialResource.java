...
public class EmbargoRecursoEspecialResource {
    ...
    public EmbargoRecursoEspecialResource(EmbargoRecursoEspecialService embargoRecursoEspecialService, EmbargoRecursoEspecialQueryService embargoRecursoEspecialQueryService) {
    ...
    public ResponseEntity<EmbargoRecursoEspecial> createEmbargoRecursoEspecial(@RequestBody EmbargoRecursoEspecial embargoRecursoEspecial) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/embargo-recurso-especials/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /embargo-recurso-especials} : Updates an existing embargoRecursoEspecial.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/embargo-recurso-especials")
    public ResponseEntity<EmbargoRecursoEspecial> updateEmbargoRecursoEspecial(@RequestBody EmbargoRecursoEspecial embargoRecursoEspecial) throws URISyntaxException {
        log.debug("REST request to update EmbargoRecursoEspecial : {}", embargoRecursoEspecial);
        if (embargoRecursoEspecial.getId() == null) {
    ...
    public ResponseEntity<List<EmbargoRecursoEspecial>> getAllEmbargoRecursoEspecials(EmbargoRecursoEspecialCriteria criteria, Pageable pageable) {
