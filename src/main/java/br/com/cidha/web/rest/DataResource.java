...
/**
 * REST controller for managing {@link br.com.cidha.domain.Data}.
 */
@RestController
@RequestMapping("/api")
public class DataResource {
    ...
    public DataResource(DataService dataService, DataQueryService dataQueryService) {
     ...
     */
    @GetMapping("/data")
    public ResponseEntity<List<Data>> getAllData(DataCriteria criteria, Pageable pageable) {
