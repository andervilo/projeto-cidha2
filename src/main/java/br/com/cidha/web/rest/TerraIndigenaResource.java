...
public class TerraIndigenaResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/terra-indigenas/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<TerraIndigena> partialUpdateTerraIndigena(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, terraIndigena.getId().toString())
        );
    }
