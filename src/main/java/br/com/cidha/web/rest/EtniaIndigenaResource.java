...
public class EtniaIndigenaResource {
    ...
    public EtniaIndigenaResource(EtniaIndigenaService etniaIndigenaService, EtniaIndigenaQueryService etniaIndigenaQueryService) {
    ...
    public ResponseEntity<EtniaIndigena> createEtniaIndigena(@RequestBody EtniaIndigena etniaIndigena) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/etnia-indigenas/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /etnia-indigenas} : Updates an existing etniaIndigena.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/etnia-indigenas")
    public ResponseEntity<EtniaIndigena> updateEtniaIndigena(@RequestBody EtniaIndigena etniaIndigena) throws URISyntaxException {
        log.debug("REST request to update EtniaIndigena : {}", etniaIndigena);
        if (etniaIndigena.getId() == null) {
