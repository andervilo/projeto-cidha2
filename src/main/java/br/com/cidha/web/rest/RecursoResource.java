...
/**
 * REST controller for managing {@link br.com.cidha.domain.Recurso}.
 */
@RestController
@RequestMapping("/api")
public class RecursoResource {
     ...
     */
    @GetMapping("/recursos")
    public ResponseEntity<List<Recurso>> getAllRecursos(RecursoCriteria criteria, Pageable pageable) {
