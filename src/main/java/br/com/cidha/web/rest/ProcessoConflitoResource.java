...
public class ProcessoConflitoResource {
    ...
    public ProcessoConflitoResource(ProcessoConflitoService processoConflitoService, ProcessoConflitoQueryService processoConflitoQueryService) {
    ...
    public ResponseEntity<ProcessoConflito> createProcessoConflito(@RequestBody ProcessoConflito processoConflito) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/processo-conflitos/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /processo-conflitos} : Updates an existing processoConflito.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/processo-conflitos")
    public ResponseEntity<ProcessoConflito> updateProcessoConflito(@RequestBody ProcessoConflito processoConflito) throws URISyntaxException {
        log.debug("REST request to update ProcessoConflito : {}", processoConflito);
        if (processoConflito.getId() == null) {
