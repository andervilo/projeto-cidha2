  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="cidhaApp.concessaoLiminar.home.createOrEditLabel">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : concessaoLiminarEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="concessao-liminar-descricao" type="text" name="descricao" />
              </AvGroup>
              <AvGroup>
                <Label for="concessao-liminar-processo">
                  <Translate contentKey="cidhaApp.concessaoLiminar.processo">Processo</Translate>
                </Label>
                <AvInput id="concessao-liminar-processo" type="select" className="form-control" name="processo.id">
                  <option value="" key="0" />
                  {processos
