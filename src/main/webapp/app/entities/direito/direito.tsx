...
import { getEntities } from './direito.reducer';
import { IDireito } from 'app/shared/model/direito.model';
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';
import { overridePaginationStateWithQueryParams } from 'app/shared/util/entity-utils';

export interface IDireitoProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}
        ...
        {direitoList && direitoList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="cidhaApp.direito.home.notFound">No Direitos found</Translate>
            </div>
          )
        )}
      </div>
      {props.totalItems ? (
        <div className={direitoList && direitoList.length > 0 ? '' : 'd-none'}>
...
const mapStateToProps = ({ direito }: IRootState) => ({
  direitoList: direito.entities,
  loading: direito.loading,
  totalItems: direito.totalItems,
});
...
export default connect(mapStateToProps, mapDispatchToProps)(Direito);
