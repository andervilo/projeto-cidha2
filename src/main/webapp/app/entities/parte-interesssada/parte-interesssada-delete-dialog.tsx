...
export const ParteInteresssadaDeleteDialog = (props: IParteInteresssadaDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="parteInteresssadaDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-parteInteresssada" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
