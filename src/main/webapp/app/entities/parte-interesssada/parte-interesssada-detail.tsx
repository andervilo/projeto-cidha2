...
export const ParteInteresssadaDetail = (props: IParteInteresssadaDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="parteInteresssadaDetailsHeading">
          <Translate contentKey="cidhaApp.parteInteresssada.detail.title">ParteInteresssada</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{parteInteresssadaEntity.id}</dd>
          <dt>
            <span id="nome">
        ...
        <Button tag={Link} to="/parte-interesssada" replace color="info" data-cy="entityDetailsBackButton">
