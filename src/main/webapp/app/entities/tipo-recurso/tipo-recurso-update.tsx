  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="cidhaApp.tipoRecurso.home.createOrEditLabel" data-cy="TipoRecursoCreateUpdateHeading">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : tipoRecursoEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="tipo-recurso-descricao" data-cy="descricao" type="text" name="descricao" />
              </AvGroup>
