...
export const TipoRepresentanteDetail = (props: ITipoRepresentanteDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        &nbsp;
        <Button tag={Link} to={`/tipo-representante/${tipoRepresentanteEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(TipoRepresentanteDetail);
