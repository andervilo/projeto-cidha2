  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="cidhaApp.opcaoRecurso.home.createOrEditLabel" data-cy="OpcaoRecursoCreateUpdateHeading">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : opcaoRecursoEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="opcao-recurso-descricao" data-cy="descricao" type="text" name="descricao" />
              </AvGroup>
