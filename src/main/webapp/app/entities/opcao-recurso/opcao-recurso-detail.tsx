...
export const OpcaoRecursoDetail = (props: IOpcaoRecursoDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        &nbsp;
        <Button tag={Link} to={`/opcao-recurso/${opcaoRecursoEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(OpcaoRecursoDetail);
