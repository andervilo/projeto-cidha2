...
export const ProblemaJuridicoDetail = (props: IProblemaJuridicoDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="problemaJuridicoDetailsHeading">
          <Translate contentKey="cidhaApp.problemaJuridico.detail.title">ProblemaJuridico</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{problemaJuridicoEntity.id}</dd>
          <dt>
        ...
        <Button tag={Link} to="/problema-juridico" replace color="info" data-cy="entityDetailsBackButton">
