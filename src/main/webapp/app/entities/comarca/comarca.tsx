...
import { getEntities } from './comarca.reducer';
...
export const Comarca = (props: IComarcaProps) => {
  ...
  return (
    <div>
      <h2 id="comarca-heading" data-cy="ComarcaHeading">
        <Translate contentKey="cidhaApp.comarca.home.title">Comarcas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="cidhaApp.comarca.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="cidhaApp.comarca.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`${match.url}/${comarca.id}`} color="info" size="sm" data-cy="entityDetailsButton">
