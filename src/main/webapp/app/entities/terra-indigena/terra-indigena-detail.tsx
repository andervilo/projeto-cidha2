...
export const TerraIndigenaDetail = (props: ITerraIndigenaDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="terraIndigenaDetailsHeading">
          <Translate contentKey="cidhaApp.terraIndigena.detail.title">TerraIndigena</Translate>
        </h2>
        ...
        <Button tag={Link} to="/terra-indigena" replace color="info" data-cy="entityDetailsBackButton">
