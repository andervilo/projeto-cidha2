...
export const RepresentanteLegalDeleteDialog = (props: IRepresentanteLegalDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="representanteLegalDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-representanteLegal" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
