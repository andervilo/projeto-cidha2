...
export const EtniaIndigenaDeleteDialog = (props: IEtniaIndigenaDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="etniaIndigenaDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-etniaIndigena" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
