...
export const EtniaIndigenaDetail = (props: IEtniaIndigenaDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="etniaIndigenaDetailsHeading">
          <Translate contentKey="cidhaApp.etniaIndigena.detail.title">EtniaIndigena</Translate>
        </h2>
        ...
        <Button tag={Link} to="/etnia-indigena" replace color="info" data-cy="entityDetailsBackButton">
