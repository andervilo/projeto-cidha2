...
export const TipoDecisaoDetail = (props: ITipoDecisaoDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="tipoDecisaoDetailsHeading">
          <Translate contentKey="cidhaApp.tipoDecisao.detail.title">TipoDecisao</Translate>
        </h2>
        ...
        <Button tag={Link} to="/tipo-decisao" replace color="info" data-cy="entityDetailsBackButton">
