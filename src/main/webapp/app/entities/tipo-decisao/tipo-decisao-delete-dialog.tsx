...
export const TipoDecisaoDeleteDialog = (props: ITipoDecisaoDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="tipoDecisaoDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-tipoDecisao" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
