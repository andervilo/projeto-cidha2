...
export const EmbargoDeclaracaoDetail = (props: IEmbargoDeclaracaoDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="embargoDeclaracaoDetailsHeading">
          <Translate contentKey="cidhaApp.embargoDeclaracao.detail.title">EmbargoDeclaracao</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{embargoDeclaracaoEntity.id}</dd>
          <dt>
            <span id="descricao">
        ...
        <Button tag={Link} to="/embargo-declaracao" replace color="info" data-cy="entityDetailsBackButton">
