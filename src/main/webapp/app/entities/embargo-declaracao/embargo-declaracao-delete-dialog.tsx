...
export const EmbargoDeclaracaoDeleteDialog = (props: IEmbargoDeclaracaoDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="embargoDeclaracaoDeleteDialogHeading">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-embargoDeclaracao" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
