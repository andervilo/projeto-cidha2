...
export const AtividadeExploracaoIlegalDetail = (props: IAtividadeExploracaoIlegalDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="atividadeExploracaoIlegalDetailsHeading">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{atividadeExploracaoIlegalEntity.id}</dd>
          <dt>
            <span id="descricao">
        ...
        <Button tag={Link} to="/atividade-exploracao-ilegal" replace color="info" data-cy="entityDetailsBackButton">
